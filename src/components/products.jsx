        ...
        <>
                ...
                <div className="row">
                    ...
                    <div className="col-xs-6 col-sm-6 col-md-4 col-lg-3 product1  bg-light" key={index}>
                        ...
                        <div className="m-auto proimg" style={{width:'200px',height:'280px'}}><Link to={`/productDetails?pid=${item._id}`} ><LazyImage src={item.images} alt={"book"} /></Link><i className={`wishicon fs-1 fw-semibold `} style={{}} onClick={()=>WishList(item._id)}>< IoIosHeartEmpty fill={likedItems.includes(item._id)? "red" : ""} /></i></div>
